...
def main():
    ...
    if sys.version_info < (3, 11):
        print("  ! Python 3.11 or newer is required: the pinned numpy, pandas, scipy and\n"
              "    scikit-learn have no 3.10 builds"); ok = False
    elif sys.version_info >= (3, 15):
        print("  ? Python 3.15 or newer: the pinned versions have not been built for it")
    else:
        print("  ok")
