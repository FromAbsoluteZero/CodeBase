...
# Each generator is the printed block of the chapter that creates the file in the book.
GENERATORS = [
    ("code/ch04/gen_retail.py",  "retail.csv"),
    ("code/ch14/gen_hr.py",      "hr.csv"),
    ("code/ch22/gen_tx.py",      "transactions.csv"),
    ("code/ch24/gen_orders.py",  "customers.csv"),
    ("code/ch26/gen_seg.py",     "segments.csv"),
    ("code/ch28/gen_daily.py",   "daily_revenue.csv"),
]
