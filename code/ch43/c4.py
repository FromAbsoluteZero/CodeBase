...
# advance the stream past x_train, exactly as Step 3 did
_ = r3.normal(50, 10, 2000)
...
print(f"\na performance monitor catches the problem at week "
      f"2, when the true")
print(f"boundary has moved only 5 of its eventual 30 units, "
      f"one sixth of the")
