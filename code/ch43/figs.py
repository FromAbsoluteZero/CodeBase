...
ax1.set_title("Two drift metrics, the same drift, separate draws: both eventually flag it",
...
_ = r3.normal(50, 10, 2000)     # advance the stream past x_train, as c4.py does, so the figure plots Step 3's draws
accs, kss = [], []
for week in weeks:
