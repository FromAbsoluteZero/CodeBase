...
ax.set_title("A small per-step error rate compounds into a large one",
             color=NAVY, fontsize=11.3, loc="left", pad=44)
# The legend sits in a row under the title rather than inside the axes: the four curves
# span the whole plotting area, so any in-axes position lands on one of them.
ax.legend(frameon=False, ncol=4, loc="lower left", bbox_to_anchor=(0.0, 1.005),
          handlelength=1.6, columnspacing=1.4, borderaxespad=0.0,
          title="per-step accuracy", alignment="left")
