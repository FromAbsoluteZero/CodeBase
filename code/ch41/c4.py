...
def simulate_agent_task(n_steps, confusion, tool_success_given_correct,
                        n_trials, seed):
...
print(f"{'steps':>7}{'confusion=0.0':>15}{'confusion=0.15':>16}"
      f"{'confusion=0.30':>16}")
for n_steps in (1, 3, 5, 10):
    row = [n_steps]
    for confusion in (0.0, 0.15, 0.30):
        rate = simulate_agent_task(n_steps, confusion,
                                   tool_success_given_correct=0.95,
