# Shared setup for Chapter 4. The chapter's blocks carry their own imports, so this file
# only makes sure the data file is in place.
# retail.csv is created by this chapter's first block, gen_retail.py. The blocks read it from the
