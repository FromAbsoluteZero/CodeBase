...
exec(open('_lib.py').read()); exec(open('c2.py').read())              # chunks, texts, queries
exec(open('c4.py').read().split('def cos')[0])                          # ix, E  (PPMI + SVD)
exec(open('c5.py').read().split('def search')[0])                       # embed, dense
