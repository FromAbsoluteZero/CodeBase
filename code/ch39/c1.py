...
# the update the target task actually needs
W_target_true = W_pretrained + A_true @ B_true

full_params = W_pretrained.size
lora_params = D * true_rank + true_rank * D

print(f"pretrained weight matrix:      {W_pretrained.shape}   "
...
print(f"that is a {full_params/lora_params:.0f}x reduction in "
